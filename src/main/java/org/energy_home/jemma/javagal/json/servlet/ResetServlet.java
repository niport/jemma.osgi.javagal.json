...
public class ResetServlet extends CommonServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			short startMode = (short) getLongParameter(request, Resources.URI_PARAM_START_MODE_RESET);

			try {
				Status status = gatewayInterface.resetDongleSync(timeout, startMode);
