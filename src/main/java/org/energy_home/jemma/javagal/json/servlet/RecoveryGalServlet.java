...
public class RecoveryGalServlet extends CommonServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			try {
				((IGalExtender) gatewayInterface).recoveryGal();
				...
				sendErrorReply(response, GatewayConstants.GENERAL_ERROR, "Error recovering gal: " + e.getMessage());
			}
